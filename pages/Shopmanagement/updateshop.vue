<template>
	<view>
		...
		<view class="uni-padding-wrap uni-common-mt">
			<view class="demo">
				<block v-if="imageSrc" >
					<image :src="imageSrc" class="image" mode=" aspectFill" @click="chooseImage" style="width: 200rpx;height: 200rpx;"></image>
				</block>
				<block v-else>
		...
		<view class="btn-row" style="display: flex;">
			...
			<button  class="cu-btn 	bg-green "  style="width: 50%;margin: 40rpx 5% 0rpx 5%;border-radius: 40rpx;" @click="showModal" data-target="Modal" >删除商品</button>
		</view>
		...
		<view class="cu-modal" :class="modalName=='Modal'?'show':''" >
			<view class="cu-dialog" >
				<view class="cu-bar bg-white justify-end">
					...
					<view class="contentt">确认删除当前商品?</view>
