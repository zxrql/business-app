<template>
	<view class="qiun-columns">
		...
		<button type="default" size="mini" @click="toDatePicker">toDatePicker</button>
	</view>
</template>
		...
		methods: {
			...
			getServerData(){
				...
				// 		//下面这个根据需要保存后台数据，我是为了模拟更新柱状图，所以存下来了
						_self.serverData= Data //res.data.data;
						let LineA={categories:[],series:[]};
						//这里我后台返回的是数组，所以用等于，如果您后台返回的是单条数据，需要push进去
						LineA.categories= Data.LineA.categories//res.data.data.LineA.categories;
						LineA.series= Data.LineA.series; //res.data.data.LineA.series;
